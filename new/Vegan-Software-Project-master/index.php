                    ...
                    <div class="info">
                        <div class="vegan-description padding-right animate-left">
                            <div class="global-headline">
                                <h2 class="sub-headline">About Us</h2>
                                <h1 class="headline">Our Story</h1>
                            </div>
                            <p class="about-text">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Enjvgvhgvhhgvhgvhgvhgvhgvhgvsci esse, aliquam quidem illo aut repellendus mollitia, pariatur ad odit sequi reiciendis nihil molestiae!
                            </p>
                            <a href="#" class="btn body-btn">About us</a>
                        </div>
                        <div class="about-pic">
                            <img src="./images/close-up-photo-of-cakes-near-glass-window-2773606.jpg">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="header text-center">
                                    <h2>The Team</h2>
                                    <p>Meet the brains behind the vegan app</p>
                                </div>
                            </div>
